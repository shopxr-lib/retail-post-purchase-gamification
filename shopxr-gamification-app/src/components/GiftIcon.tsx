...
const GiftIcon = ({ onClick, top, side, offset, bgColor, iconColor }: GiftIconProps) => {
  return (
    <div
      onClick={onClick}
      className="absolute cursor-pointer"
      style={{
        top: `clamp(25px, ${top}%, calc(100% - 25px))`,
            ...
            <g>
              <g>
                <path
                  ...
                  fill={iconColor} // Change this hex color to whatever you want!
                />
                <path
                  d="M179.374,243.186H13.749v131.459c0,17.441,14.141,31.57,31.57,31.57h134.055V243.186z M56.788,373.086
                  ...
                  fill={iconColor} // Same color as above
                />
              </g>
              <path
                d="M371.176,119.564h-59.293c8.184-3.928,15.049-7.986,19.2-12.133c24.423-24.419,24.423-64.03,0-88.453
                ...
                fill={iconColor} // Gift box lid/ribbon color - change this too!
              />
            </g>
          </g>
        </svg>
